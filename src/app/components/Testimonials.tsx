...
const data = [
  {
    ...
    name: "John D",
    reveiw:
      "Working with Banks Construction was an absolute pleasure. Their team's attention to detail and commitment to delivering high-quality results exceeded our expectations. They were professional, reliable, and completed the project on time. Highly recommend!",
  },
...

  {
    ...
    name: "Rayyan Ryan",
    reveiw:
      "Banks Construction provided exceptional construction management services for our commercial project. Their expertise and proactive approach ensured smooth coordination among subcontractors, and they were responsive to our needs throughout. The end result was a beautifully constructed building that perfectly met our requirements.",
  },

  {
    ...
    reveiw:
      "We engaged Banks Construction for a major renovation, and they truly transformed our property. Their team's expertise, project management skills, and clear communication made the entire process stress-free. The quality of their workmanship and their dedication to client satisfaction are commendable. We are grateful for their outstanding service.",
  },
];
